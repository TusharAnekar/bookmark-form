...
import { bookmarksReducer, initialBookmarks } from "../reducers/bookmarkReducer";
...
const BookmarksProvider:React.FC<{children: ReactNode}> = ({children}) => {
    const [bookmarks, setBookmarks] = useReducer(bookmarksReducer, initialBookmarks)
    ...
    return(
        <BookmarksContext.Provider value={{bookmarks, handleAddBookmark, handleRemoveBookmark}}>
            {children}
